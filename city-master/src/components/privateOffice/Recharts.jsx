...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Text } from "recharts";
...
export const Recharts = () => {
  ...
  useEffect(() => {
    fetchStatistic(uid).then((res) => setData(res));
  }, [uid]);
    ...
    <>
      ...
      >
        ...
        <XAxis
          ...
          tick={{ fontSize: 20 }}
          label={
            <Text x={0} y={0} dx={50} dy={450} offset={0} angle={-90}>
              Очки:
            </Text>
          }
        />
        ...
        <YAxis
          ...
          tick={{ fontSize: 20 }}
          label={
            <Text x={0} y={0} dx={80} dy={460} offset={0}>
              Дата:
            </Text>
          }
        />
